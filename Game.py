...
import cvzone
import os 
os.chdir(r"C:\Users\mreda\OneDrive\Desktop")
...
fourcc = cv.VideoWriter_fourcc(*'mp4v')  # 'mp4v' is a common codec for .mp4 files
out = cv.VideoWriter('output.mp4', fourcc, 30.0, (640, 480))  # Save as .mp4
...
bat = cv.imread('pp.png',cv.IMREAD_UNCHANGED)
